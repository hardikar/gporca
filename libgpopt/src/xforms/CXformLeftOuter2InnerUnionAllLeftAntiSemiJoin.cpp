...
CXformLeftOuter2InnerUnionAllLeftAntiSemiJoin::Exfp
	...
	const
{
	CColRefSet *pcrsInner = exprhdl.PcrsOutput(1 /*child_index*/);
	...
	const
{
	...
	CColRefSet *pcrsJoinOutput = pexpr->PcrsOutput();
	...
	CColRefSet *pcrsScalar = pexprScalar->DerivePropsScalar()->PcrsUsed();

	...
	class CXformUtils
	{
		...
		public:
			...
			void CreateBitmapIndexProbeOps
				...
				CMDAccessor *md_accessor,
				CExpression *pexprOriginalPred,
				ExpressionArray *pdrgpexprPreds,
				CTableDescriptor *ptabdesc,
				const IMDRelation *pmdrel,
				ColRefArray *pdrgpcrOutput,
				CColRefSet *outer_refs,
			...
			void CreateBitmapIndexProbes
				...
				ExpressionArray *pdrgpexprBitmap,
				ExpressionArray *pdrgpexprRecheck,
				ExpressionArray *pdrgpexprBitmapNew,
				ExpressionArray *pdrgpexprRecheckNew,
				ExpressionArray *pdrgpexprResidual
				);
			...
			void JoinBitmapIndexProbes
					(
					 IMemoryPool *pmp,
					 ExpressionArray *pdrgpexprBitmapOld,
					 ExpressionArray *pdrgpexprRecheckOld,
					 BOOL fConjunction,

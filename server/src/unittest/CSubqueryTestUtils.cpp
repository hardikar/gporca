	...
	)
{
	...
	CColRef *pcrInner = pexprR->PcrsOutput()->PcrAny();
	CColRef *pcrOuter = pexprT->PcrsOutput()->PcrAny();
	...
	)
{
	...
	CColRef *pcrInner = pexprInner->PcrsOutput()->PcrAny();

	CExpression *pexprOuter = CTestUtils::PexprLogicalGet(mp);
	CColRef *pcrOuter = pexprOuter->PcrsOutput()->PcrAny();
	...
	)
{
	...
	if (fCorrelated)
	{
		...
		CColRef *pcrOuter = pexpr->PcrsOutput()->PcrAny();
		CColRef *pcrInner = pexprInnerSelect->PcrsOutput()->PcrAny();
	...
	)
{
	...
	CColRefSet *pcrs = pexprInner->PcrsOutput();
	...
	)
{
	...
	CColRef *pcrInner = pexprGb->PcrsOutput()->PcrAny();
	CColRef *pcrOuter = pexprOuter->PcrsOutput()->PcrAny();

...
COrderSpecTest::EresUnittest_Basics()
{
	...
	CColRef *pcr1 = pcf->PcrCreate(pmdtypeint4, -1 /* iTypeModifier */, name);
	CColRef *pcr2 = pcf->PcrCreate(pmdtypeint4, -1 /* iTypeModifier */, name);
	CColRef *pcr3 = pcf->PcrCreate(pmdtypeint4, -1 /* iTypeModifier */, name);

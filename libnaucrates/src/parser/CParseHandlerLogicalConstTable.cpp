	...
	)
{
	if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenLogicalConstTable), element_local_name))
	{
		...
		CDXLLogicalConstTable *lg_const_table_get_dxl_op = GPOS_NEW(m_memory_pool) CDXLLogicalConstTable(m_memory_pool, dxl_col_descr_array, m_const_tuples_datum_array);

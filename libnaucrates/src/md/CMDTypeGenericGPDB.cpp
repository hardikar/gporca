	...
	m_pdatumNull(NULL)
{
	...
	m_pmdid->AddRef();
	m_pdatumNull = GPOS_NEW(m_pmp) CDatumGenericGPDB(m_pmp, m_pmdid, -1 /* iTypeModifier */, NULL /*pba*/, 0 /*ulLength*/, true /*fConstNull*/, 0 /*lValue */, 0 /*dValue */);
}
	...
	const
{
	...
	return Pdxldatum(pmp, m_pmdid, -1 /* iTypeModifier */, m_fByValue, true /*fConstNull*/, NULL /*pba*/, 0 /*ulLength*/, 0 /*lValue */, 0 /*dValue */);
}
